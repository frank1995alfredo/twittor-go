...
/*LeoUsuariosTodos ... lee todos los usuarios registrados en el sistema, si se recibe "R"
en quiene trae solo los que se relacionan conmigo*/
func LeoUsuariosTodos(ID string, page int64, search string, tipo string) ([]*models.Usuario, bool) {
	...
	findOptions.SetLimit(20) //solo devuelve 20 resultados
